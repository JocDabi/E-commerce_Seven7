...
<body>
    <div class="container">
        <h1 class="text-center mb-5">Generar Reporte de Clientes por Fecha de Registro</h1>
        <form action="generar_reporte_clientes.php" method="post">
            <div class="row mb-3">
                ...
                <div class="col align-self-end">
                    <button type="submit" class="btn btn-primary w-100" name="submit">Generar Reporte de Clientes</button>
                </div>
            </div>
        </form>
