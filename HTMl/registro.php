    ...
    <body class="w-[100%] h-screen bg-gradient-to-b from-pink-300 via-pink-200 to-pink-100 overflow-x-hidden overflow-y-hidden">
        ...
        <div class="w-full flex flex-col gap-8 items-center mt-4">
            <form class="flex flex-col items-center gap-4 mt-6" action="../procesar_registro.php" method="post">
                ...
                <input class="w-[250px] h-[40px] bg-white/70 outline-0 rounded-full text-center placeholder:text-[rgb(95,22,24)] placeholder:font-[500] focus:placeholder-transparent" type="text" name="direccion" placeholder="Direccion" required>
                ...
                <div class="flex gap-2 ml-10">
                    ...
                    <label class="text-[0.8rem] text-[rgb(95,22,24)]" for="privacidad">He leido y estoy de acuerdo con las <a href="#" class="underline" >politicas de privacidad.</a></label>
                </div>
